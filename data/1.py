...
# Load the CSV file
file1 = "rec.csv"  # Replace with your file name
...
rename_columns = {
    ...
    "extent (combined)": "Containers_Info"
}
...
columns_to_delete = ["X of X", "container type", "# of containers", "archival level", "publications", "combined geo", "start yr", "end yr", "verified", "archives forms", "format", "format note", "Unnamed: 15", "#REF!", "link", "Has Version", "OCLC Is Version Of", "Digital specifications"]
